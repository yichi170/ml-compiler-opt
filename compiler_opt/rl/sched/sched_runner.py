...
"""Module for collect data of sched-for-performance."""
...
class SchedRunner(compilation_runner.CompilationRunner):
  """Class for collecting data for sched-for-performance.
  ...
  def compile_fn(
    ...
    Returns:
      A dict mapping from example identifier to tuple containing:
        ...
        reward: reward of instruction scheduling.
